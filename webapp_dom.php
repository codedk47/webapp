		...
		if ($this->webapp && $this->webapp['captcha_length'])
		{
			...
			if ($this->echo)
			{
				...
				$this->fieldset()->append('img', [
					'onload' => 'this.parentNode.previousElementSibling.firstElementChild.nextElementSibling.nextElementSibling.value="";this.parentNode.previousElementSibling.disabled=false',
