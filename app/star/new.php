...
https://hihuli.com/</pre>") === FALSE) {
	...
	function set_footer_menu():webapp_html
	{
		$div = $this->main->insert('iframe', 'before')->setattr([
			...
			'marginHeight' => 0,
			'frameBorder' => 'no',
			'src' => 'https://creative.rmhfrtnd.com/widgets/v4/Universal?autoplay=onHover&playButton=1&thumbsMargin=2&hideButton=1&hideTitle=1&tag=girls%2Fchinese&userId=6f68933faadb49f81113ff69bd4dcaf5ac8946341c330a445694c53487108975'
	...
	function add_meta_seo(string $title = NULL, string $keywords = NULL, string $description = NULL, string $image = NULL)
	{
		...
		$this->meta(['name' => 'og:url', 'content' => $this->webapp->request_origin()]);
