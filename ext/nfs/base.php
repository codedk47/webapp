...
{
	function __construct(public readonly webapp $webapp, public readonly int $sort, array ...$configs)
	{
...
class webapp_ext_nfs_base extends webapp
{
	...
	function nfs(int $sort = 0, array ...$configs):webapp_nfs
	{
		return $this->nfs[$sort &= 0xff] ??= new webapp_nfs($this, $sort, ...$configs);
	}
